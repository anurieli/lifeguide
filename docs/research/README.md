...
| [`raw/internal-notes/horizons-vision-goals-blend.md`](raw/internal-notes/horizons-vision-goals-blend.md) | Should the vision board, the horizons ladder, and goals be one blended alignment spine (measurable goals + deadlines, felt far future on the board, a calm daily glimpse)? Plus the Profile "all of you" surface. | raw | Linear TBD (MCP down at park) |
