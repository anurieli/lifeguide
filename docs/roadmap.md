...
- **App shell + rail nav.** Onboarding, the Today/Board/Guide/Settings rail, the docked Coach.
- **Today ritual.** The morning/evening beats wired to the interactions log.
- **Partial Guide / Settings.** Guide renders the north star, the live Mirror, and pillar blocks; Settings persists rhythm/tone and manages pillars.
