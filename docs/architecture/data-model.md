...
interviewSessions {
  ...
  startedAt: number,
  endedAt?: number,
  summary?: {                   // Listener memory backbone (ARI-23, ADR 0022) — "listen" only
