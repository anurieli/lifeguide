...
- **Daily Ritual: `built` (2026-07-12).** Two small user-editable checklists (morning and night) hosted on Today that turn the bookends of the day into a digital ritual: "do" steps and inline mantra "read" steps, time-of-day selection, per-day check state with completion history, defaults seeded from the Blueprint for Living doctrine. The conduct half of the two bookends; the Journal is the reflective half. → [`features/daily-ritual.md`](features/daily-ritual.md)
