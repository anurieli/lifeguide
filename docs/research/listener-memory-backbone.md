...
> **Status:** RESOLVED 2026-07-18 (ARI-23). All five open questions below were decided and built. The answer lives in [`../decisions/0022-listener-memory-backbone.md`](../decisions/0022-listener-memory-backbone.md) (the decision record), [`../product/features/listener.md`](../product/features/listener.md) §2/§4/§7-9 (the feature behavior), and [`../architecture/data-model.md`](../architecture/data-model.md) (`interviewSessions.summary`). This note is kept as-is below for the original reasoning trail; it is no longer the source of truth.
...
All five questions in §3 were decided; see [ADR 0022](../decisions/0022-listener-memory-backbone.md) for the full reasoning:
