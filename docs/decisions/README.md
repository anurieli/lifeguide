...
| [0022](0022-listener-memory-backbone.md) | The Listener's memory backbone: session-per-speaker, post-call summaries, tossed calls included | accepted (live) | 2026-07-18 |
