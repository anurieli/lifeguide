...
**One thing:** the conversation. It sits beside the work, never over it — including the work's own controls: while a thought document is open, its capture buttons (photo + record) hold the bottom-right corner and the Coach cluster steps aside (`stepAside` on `CoachDock`, 2026-07-13); it returns the moment the document closes.
